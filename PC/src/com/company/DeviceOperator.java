...
class DeviceOperator {
	...
	private void operateMouse() {
		...
		switch (this.getDeviceOperationType()) {
			case MOUSE_MOVE:
				x = Integer.valueOf(deviceOperationValues.get(0).getTokenValue());
				y = Integer.valueOf(deviceOperationValues.get(1).getTokenValue());
...
//				new MouseHandler().dragMouse(new Point(x, y));
				break;
